...
export class CategoriaFornecedorController {
  constructor(private readonly categoriaFornecedorService: CategoriaFornecedorService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateCategoriaFornecedorDto: UpdateCategoriaFornecedorDto) {
    return this.categoriaFornecedorService.update(+id, updateCategoriaFornecedorDto);
  }
